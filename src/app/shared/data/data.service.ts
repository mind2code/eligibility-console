...
export class DataService {
  ...
  public sideBar: SideBar[] =[
      ...
      menu: [
        {
          ...
          showSubRoute: false,
          icon: 'cash',
          base: 'transactionAchatsList',
          materialicons: '',
          subMenus: [
            {
              menuValue: 'Achat energie',
              route: routes.transactionAchatsList,
              base: 'transactionAchatsList',
            },
            {
              menuValue: 'Règlement dette',
              route: routes.transactionDetteList,
              base: 'transactionDetteList',
            },
          ],
        },
      ]
    },
    {
      ...
      menu: [
        {
          menuValue: 'Dictionnaires',
          route: routes.dictionnaireList,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'link',
          base: 'super-admin',
